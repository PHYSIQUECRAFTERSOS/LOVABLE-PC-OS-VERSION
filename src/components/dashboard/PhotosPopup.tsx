    ...
    <Drawer open={open} onOpenChange={(o) => !o && onClose()}>
      <DrawerContent className="max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          ...
          <h2 className="text-base font-bold text-foreground">Take Progress Photos</h2>
          <div className="w-5" />
        </div>
        ...
        <div className="overflow-y-auto px-4 pb-4 space-y-5">
          ...
          <div className="flex flex-col items-center gap-2 py-3">
            ...
            <p className="text-xs text-muted-foreground text-center max-w-[280px]">
              Upload your front, side, and back photos. You can upload one at a time and label each angle.
            </p>
          </div>
